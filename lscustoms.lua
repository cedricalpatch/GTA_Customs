...
local garages = { 
	[1] = { locked = false, camera = {x = -235.6818, y = 2383.2412, z = 22.0031, heading =  131.84}, driveout = {x = -240.2546, y = 2390.4104,z =  20.2649, heading = 360.226}, drivein = {x = -239.9042, y = 2392.7192, z = 20.3046, heading = 180.532}, outside = { x = -238.5037, y = 2402.2056, z = 20.264, heading = 360.187133}, inside = {x = -239.6311, y =  2378.8044,z =  20.3047, heading = 180.455}},
    [2] = { locked = false, camera = {x = -1083.3342, y = 2021.4915, z = 19.903, heading =  51.537}, driveout = {x = -1080.2195, y = 2017.3199,z = 16.8758, heading = 179.093 }, drivein = {x = -1079.7327, y =  2013.8396,z = 16.4382, heading = 359.0156}, outside = { x = -1080.5111, y = 2014.3335, z = 1.1884 , heading = 197.7715}, inside = {x = -1080.3937, y =  2029.889,z =  17.2895, heading =  0.2046}},
 --   [2] = { locked = false, camera = {x = -1083.3342, y = 2021.4915, z = 19.903, heading =  51.537}, driveout = {x = -1080.1011,y = 2014.0182,z =  16.228, heading = 179.093 }, drivein = {x = -1079.672, y = 2028.4547, z = 17.0706, heading = 359.0156}, outside = { x = -1079.3245, y = 2010.4225, z = 16.0837, heading = 197.7715}, inside = {x = -1079.8854, y =  2030.647,z =  17.0708, heading = 0.0824}},
    [3] = { locked = false, camera = {x = 933.5381 , y = 721.4111, z = 8.7003, heading =  93.8709}, driveout = {x = 944.0793, y =  718.6766,z =  5.5848, heading = 88.761 }, drivein = {x = 938.2654, y = 717.9108, z = 5.5846, heading = 269.6072}, outside = { x = 927.5183, y = 718.9626, z = 5.4791, heading = 69.5115}, inside = {x = 944.5021, y =  724.7715,z =  5.5848, heading = 332.6266}},
...
local function DriveOutOfGarage(pos)
	Citizen.CreateThread(function()
	    ...
	    TriggerEvent("GTAO:NotificationIcon", "CHAR_HAO", "Custom Garage", "Modification véhicule", "Merci pour votre visite à bientôt j'espére, pas de folie elle est en rodage !")
...
Citizen.CreateThread(function()
	while true do
		...
		if inside == false then
			...
			--TriggerEvent("GTA-Notification:InfoInteraction", "Besoin d'un vehicule.")
					...
					for i,pos in ipairs(garages) do
						...
						if LSC_Config.oldenter then			
							...
							if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= f(5) then
					          --  TriggerEvent("GTA-Notification:InfoInteraction", "Touche ~INPUT_PICKUP~ pour modifier votre vehicule.")
								...
								if not tableContains(LSC_Config.ModelBlacklist,GetDisplayNameFromVehicleModel(GetEntityModel(veh)):lower()) then
									...
									if pos.locked then
										...
										if not LSC_Config.lock then
					                        ...
					                        TriggerEvent("GTA-Notification:InfoInteraction", "Touche ~INPUT_VEH_ATTACK2~ pour appeler le garagiste.")
											end
										else
					                        TriggerEvent("GTA-Notification:InfoInteraction", "Patience le garage est occupé.")
										end
									else
										if IsControlJustPressed(1,70) then
											inside = true
                                	...
                                	TriggerEvent('nMenuNotif:showNotification', "Votre véhicule est ~y~Interdit~s~ ici !")
								end
							end
						else
	...
	while true do
		...
		if LSCMenu:isVisible() then
			...
			if IsDisabledControlJustPressed(1,0) or IsControlJustPressed(1,0) then -- V
			   -- TriggerEvent("GTAO:NotificationIcon", "CHAR_DEVIN", "Custom Garage", "Bienvenue a toi !", "Choisi les modif de tu souhaite et je les installe...\nN'oublie pas de rapporté ta voiture dans ton garage personnel !")
